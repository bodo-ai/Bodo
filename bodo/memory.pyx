...
def set_default_buffer_pool_as_arrow_memory_pool():
    ...
    """
    py_ptr: int = bodo.ext.memory_cpp.default_buffer_pool_ptr()
...
default_buffer_pool_smallest_size_class = bodo.ext.memory_cpp.default_buffer_pool_smallest_size_class
default_buffer_pool_bytes_allocated = bodo.ext.memory_cpp.default_buffer_pool_bytes_allocated
default_buffer_pool_bytes_pinned = bodo.ext.memory_cpp.default_buffer_pool_bytes_pinned

atexit.register(bodo.ext.memory_cpp.default_buffer_pool_cleanup)
