...
def CallConstraint_resolve(self, typeinfer, typevars, fnty):
    ...
    streaming_build_funcs = (groupby_build_consume_batch, groupby_grouping_sets_build_consume_batch, join_build_consume_batch, join_probe_consume_batch, window_build_consume_batch, union_consume_batch, table_builder_append)
