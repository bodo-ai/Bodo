    ...
    def _run_call(self, assign, equiv_set, avail_vars):
        ...
        if (
            ...
            if self._is_1D_or_1D_Var_arr(rhs.args[0].name):
                ...
                f = lambda y_true, y_pred, sample_weight, multioutput, squared: sklearn.metrics.mean_squared_error(
                    y_true,
                    y_pred,
                    sample_weight=sample_weight,
        ...
        if func_mod == "sklearn.metrics._regression" and func_name == "r2_score":
            ...
            if self._is_1D_or_1D_Var_arr(rhs.args[0].name):
                ...
                f = lambda y_true, y_pred, sample_weight, multioutput: sklearn.metrics.r2_score(
                    y_true,
                    y_pred,
                    sample_weight=sample_weight,
                    multioutput=multioutput,
