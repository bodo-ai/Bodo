...
_np_type_names = {"int8", "int16", "int32", "int64", "uint8", "uint16", "uint32", "uint64", "float32", "float64", "bool_"}
...
def get_const_value_inner(
    ...
    if call_name is not None and call_name[1] == "numpy" and call_name[0] in _np_type_names:
