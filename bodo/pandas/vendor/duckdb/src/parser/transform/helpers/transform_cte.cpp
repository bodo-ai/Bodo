...
// Bodo Change: Remove parser code
...
CTEMaterialize CommonTableExpressionInfo::GetMaterializedForSerialization(Serializer &serializer) const { if (serializer.ShouldSerialize(7)) {
		return materialized;
	}
