...
cdef extern from "_plan.h" nogil:
    ...
    cdef unique_ptr[CExpression] make_scalar_subquery_expr(unique_ptr[CLogicalOperator] subquery) except +
...
cdef class ScalarSubqueryExpression(Expression):
    ...
    def __cinit__(self, object out_schema, LogicalOperator parent_plan, LogicalOperator subquery_plan):
        self.out_schema = out_schema
        self.c_expression = make_scalar_subquery_expr(parent_plan.c_logincal_operator, subquery_plan.c_logical_operator)
