...
cdef extern from "_plan.h" nogil:
    ...
    cdef void set_use_cudf(c_bool use_cudf, c_string cache_dir, c_bool dump_plans) except +
...
cpdef c_set_use_cudf(use_cudf, cache_dir, dump_plans):
    set_use_cudf(use_cudf, cache_dir.encode(), dump_plans)
