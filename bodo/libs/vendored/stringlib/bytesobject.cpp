...
void *_C_BytesWriter_Resize(_C_BytesWriter *writer, void *str,
                            Py_ssize_t size) {
...
void *_C_BytesWriter_Prepare(_C_BytesWriter *writer, void *str,
                             Py_ssize_t size) {
...
int64_t _C_BytesWriter_Finish(char *out_data, _C_BytesWriter *writer,
                              void *str) {
    Py_ssize_t size;
