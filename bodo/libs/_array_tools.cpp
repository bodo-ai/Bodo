...
void fill_send_array(array_info* send_arr, array_info *array, uint32_t *hashes, std::vector<int> &send_disp, int n_pes)
{
...
table_info* (table_info* in_table, int64_t n_keys)
{
    // error checking
