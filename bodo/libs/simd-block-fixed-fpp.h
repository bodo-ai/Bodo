...
//   the compiler when building extension modules that don't need the march=haswell
//   flag because they don't use bloom filters. Note that we need this because
//   mpi_comm_info depends on SimdBlockFilterFixed and mpi_comm_info is in
//   _bodo_common.h :(
