...
@pytest.mark.skip(
    reason="[BSE-943] TODO: Support scipy.fftpack.fftshift forworkload"
)
...
@pytest.mark.skip(reason="[BSE-949] TODO: Support np.asmatrix forworkload")
...
@pytest.mark.skip(reason="[BSE-945] TODO: Support np.nan_to_num forworkload")
@pytest.mark.parametrize(
    "shape",
    [
