...
def test_is_array(vector, data, answer, memory_leak_check):
    ...
    def impl_vector(data):
        return pd.Series(bodo.libs.bodosql_array_kernels.is_array(data))

    def impl_scalar(data):
        return bodo.libs.bodosql_array_kernels.is_array(data[0])
...
def test_is_object(data, answer, memory_leak_check):
    ...
    def impl(data):
        return pd.Series(bodo.libs.bodosql_array_kernels.is_object(data))
