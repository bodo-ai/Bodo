...
def test_to_char(input, is_scalar, expected):
    ...
    def impl(arr):
        return bodo.libs.bodosql_array_kernels.to_char(arr, None, is_scalar)
...
def test_to_char_format_str(arr, format_str, is_scalar_arr, expected):
    def impl(arr, format_str):
        return bodo.libs.bodosql_array_kernels.to_char(arr, format_str, is_scalar_arr)
...
def test_option_to_char(flag0, flag1, memory_leak_check):
    def impl(arr, format_str, flag0, flag1):
        ...
        return bodo.libs.bodosql_array_kernels.to_char(arg0, arg1, is_scalar=True)
