...
df = pd.DataFrame(
    {
        "one": [-1, np.nan, 2.5, 3.0, 4.0, 6.0, 10.0, -1, np.nan, 2.5, 3.0, 4.0, 6.0, 10.0],
        "two": ["foo", "bar", "baz", "foo", "bar", "baz", "foo", "foo", "bar", "baz", "foo", "bar", "baz", "foo"],
        "three": [True, False, True, True, True, False, False, True, False, True, True, True, False, False],
        "four": [-1, 5.1, 2.5, 3.0, 4.0, 6.0, 11.0, -1, 5.1, 2.5, 3.0, 4.0, 6.0, 11.0],  # float without NA
        "five": ["foo", "bar", "baz", "", "bar", "baz", "foo", "foo", "bar", "baz", "", "bar", "baz", "foo"],  # str without NA
    }
)
sdf = spark.createDataFrame(df)
