# Taken from: https://github.com/Bodo-inc/Bodo-examples/blob/cdf72e0caba26b6a02eb645c7af949a5bdd65174/06-Bodo-Free-Trial/2-ETL-with-Bodo/1-ETL-iceberg-data%20lakehouse.ipynb
import bodo
import time
import numpy as np
import pandas as pd
...
try:
    ...
    print(" ############## bodo_iceberg_connector not ##################### ")
    sys.exit(1)

# Location of Iceberg Warehouse
iceberg_conn = f"iceberg+s3://bodo-example-data/tpch-iceberg"
...
def run_queries(iceberg_conn, iceberg_db_schema):
    ...
    customer = pd.read_sql_table("customer", iceberg_conn, iceberg_db_schema)
