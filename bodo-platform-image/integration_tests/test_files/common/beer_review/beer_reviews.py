# Copied from https://github.com/Bodo-inc/Bodo-examples/blob/master/05-Business-Usecases-at-Scale/7-Terminal-mpiexec-examples/1-Text-mining-beer-reviews/beer-reviews.py
"""
