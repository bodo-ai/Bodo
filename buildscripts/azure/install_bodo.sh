...
conda install -y h5py=2.10 scipy bodo=$BODO_VERSION $numba_channel_flag -c https://${USERNAME}:${TOKEN}@bodo.jfrog.io/artifactory/api/conda/$artifactory_channel/$sub_channel -c conda-forge
