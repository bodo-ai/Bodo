...
* An account on Bodo Platform
* A personal machine with conda install/set up.
...
4. Run the benchmark script using `python dask/nyc_taxi_precipitation.py`. This creates the cluster and runs the benchmark 3
...
4. Run the benchmark `./wait_for_steps.sh` this script will run the benchmark 3 times.
