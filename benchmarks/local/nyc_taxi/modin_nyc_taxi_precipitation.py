"""
Modin-Ray implementation of the High Volume For Hire Vehicle benchmark workload
...
def run_modin(fhvhv_dataset):
    ...
    monthly_trips_weather_ray.write_parquet("modin_result.pq")
    end = time.time()
...
if __name__ == "__main__":
    ...
    result = run_modin(fhvhv_dataset)
