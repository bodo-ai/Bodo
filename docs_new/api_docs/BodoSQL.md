...
Bodo SQL can generate Pandas code from SQL queries automatically. To
view the code generated, you can use the `convert_to_pandas` method,
which returns the generated code as a string. For example:
...
Using Python/Pandas code instead of SQL can simplify existing data
science applications and improve code maintenance.
