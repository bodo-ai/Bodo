...
class SeriesPass(object):
    ...
    def _handle_df_dropna(self, assign, lhs, rhs):
        ...
        for v in list_str_colnames:
            func_text += "  index_offsets = bodo.libs.list_str_arr_ext.get_index_offset_ptr(out_arr)
        ...
        for v, out in zip(in_names, out_names):
            ...
            if v in list_str_colnames:
                ...
                func_text += "          out_arr._data_offsets[curr_s_offset + str_ind] = curr_d_offset\n"
                ...
                func_text += "              out_arr._data, curr_d_offset\n"
                func_text += "          )\n"
                func_text += "          bodo.libs.str_arr_ext._memcpy(out_ptr, in_ptr, n_char, 1)\n"
                func_text += "          curr_d_offset += n_char\n"
                func_text += "          str_ind += 1\n"
                func_text += "      out_arr._index_offsets[out_ind] = curr_s_offset\n"
                func_text += "      curr_s_offset += n_str\n"
                continue
