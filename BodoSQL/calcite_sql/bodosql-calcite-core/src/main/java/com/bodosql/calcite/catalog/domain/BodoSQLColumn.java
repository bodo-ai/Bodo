...
public interface BodoSQLColumn {
   ...
   * https://bodo.atlassian.net/wiki/spaces/BodoSQL/pages/1130201106/Column
   */
  ...
  public enum BodoSQLColumnDataType {
    ...
    private BodoSQLColumnDataType(int type_id, String type_id_name) {
