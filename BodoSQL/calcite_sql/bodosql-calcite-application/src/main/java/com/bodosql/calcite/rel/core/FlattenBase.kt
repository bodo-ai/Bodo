 ...
 */
open class FlattenBase(cluster: RelOptCluster, traits: RelTraitSet, input: RelNode, call: RexCall, callType: RelDataType, usedColOutputs: ImmutableBitSet, repeatColumns: ImmutableBitSet) : Flatten(cluster, traits, input, call, callType, usedColOutputs, repeatColumns) {
