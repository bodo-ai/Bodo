...
@Value.Enclosing
public class BodoPhysicalJoinRebalanceOutputRule<
        C extends BodoPhysicalJoinRebalanceOutputRule.Config>
  ...
  protected BodoPhysicalJoinRebalanceOutputRule(C config) {
    super(config);
  }

  @Nullable
  public static RelNode generateNewProject(BodoPhysicalProject project, BodoPhysicalJoin join) {
  ...
  public void onMatch(RelOptRuleCall call) {
    BodoPhysicalProject project = call.rel(0);
    BodoPhysicalJoin join = call.rel(1);
  ...
  public interface Config extends RelRule.Config {
    Config DEFAULT_CONFIG =
        ImmutableBodoPhysicalJoinRebalanceOutputRule.Config.of()
            .withOperandFor(BodoPhysicalProject.class, BodoPhysicalJoin.class);

    @Override
    default BodoPhysicalJoinRebalanceOutputRule toRule() {
      return new BodoPhysicalJoinRebalanceOutputRule(this);
    }

    /** Defines an operand tree with two classes. */
    default BodoPhysicalJoinRebalanceOutputRule.Config withOperandFor(
        Class<? extends BodoPhysicalProject> projectClass,
        Class<? extends BodoPhysicalJoin> joinClass) {
                      ...
                      .oneInput(
                          b1 ->
                              b1.operand(joinClass)
                                  ...
                                  .anyInputs()))
          .as(BodoPhysicalJoinRebalanceOutputRule.Config.class);
    }
  }
}
