...
class TabularCatalog(warehouse: String, token: String? = null, credential: String? = null) : IcebergCatalog<RESTCatalog>(
    createRestCatalog("https://api.tabular.io/ws", warehouse, token, credential),
) {
    /**
    ...
    companion object {
        ...
        private fun createRestCatalog(
            ...
            restCatalog.initialize("TabularCatalog", params)
            return restCatalog
        }
    }
}
