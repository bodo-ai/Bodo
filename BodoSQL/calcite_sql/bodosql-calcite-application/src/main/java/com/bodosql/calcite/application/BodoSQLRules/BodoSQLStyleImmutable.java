 ...
 * This is copied from the calcite equivalent file (core/src/main/java/org/apache/calcite/CalciteImmutable.java)
 * so that we have the same method names when we are working with our custom rules.
 */
