...
public class SqlException extends Exception {
  ...
  public static void pointInQueryString(
      final StringBuilder builder, final String queryString, final SqlPosition sqlPosition) {
  ...
  static final class SqlPosition {
    ...
    public SqlPosition(
        final int lineNum, final int columnNum, final int endLineNum, final int endColumnNum) {
