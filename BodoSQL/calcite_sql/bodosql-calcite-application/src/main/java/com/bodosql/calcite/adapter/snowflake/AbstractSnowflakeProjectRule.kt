...
@Value.Enclosing
abstract class AbstractSnowflakeProjectRule protected constructor(
    config: Config,
    ...
    companion object {
         ...
         */
        private fun isSupportedCall(call: RexCall): Boolean = SUPPORTED_CALLS.contains(call.operator.name) && checkOperandsPushable(call)
         ...
         * @return true/false
         */
        private fun isVariantPushableNode(node: RexNode): Boolean = (node.type is VariantSqlType && isPushableNode(node))
         ...
         * - Variant CAST calls
         */
        private class PushableDetectionVisitor(
            private val pushableNodes: MutableSet<RexNode>,
         ...
         */
        @JvmStatic
        fun getPushableNodes(project: Project): Set<RexNode> = getPushableNodes(project.projects)
