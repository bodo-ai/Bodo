...
class SnowflakeTableScan private constructor(
    cluster: RelOptCluster,
    traitSet: RelTraitSet,
    table: RelOptTable,
    val keptColumns: ImmutableBitSet,
    private val catalogTable: SnowflakeCatalogTable,
) : TableScan(cluster, traitSet.replace(SnowflakeRel.CONVENTION), ImmutableList.of(), table),
    SnowflakeRel {
    /**
    ...
    override fun copy(
        traitSet: RelTraitSet,
        inputs: List<RelNode>,
    ): SnowflakeTableScan = copy(traitSet, keptColumns)

    private fun copy(
        traitSet: RelTraitSet,
        keptColumns: ImmutableBitSet,
    ): SnowflakeTableScan = SnowflakeTableScan(cluster, traitSet, table, keptColumns, catalogTable)
     ...
     */
    fun prunesColumns(): Boolean = keptColumns.cardinality() != table.getRowType().fieldCount
