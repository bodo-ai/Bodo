...
class SqlSnowflakeUpdate(pos: SqlParserPos,
                         targetTable: SqlNode,
                         ...
                         alias: SqlIdentifier?,
                         val from: SqlNode?) : SqlUpdate(pos, targetTable, targetColumnList, sourceExpressionList, condition, sourceSelect, alias) {
