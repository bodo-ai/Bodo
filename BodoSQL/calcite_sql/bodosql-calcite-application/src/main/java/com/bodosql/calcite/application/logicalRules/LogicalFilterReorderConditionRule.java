...
public class LogicalFilterReorderConditionRule
  ...
  public void onMatch(RelOptRuleCall call) {
    ...
    if (changed) {
      ...
      Filter newFilter = filter.copy(filter.getTraitSet(), filter.getInput(), updatedOR.getKey());
  ...
  public interface Config extends RelRule.Config {
    ...
    LogicalFilterReorderConditionRule.Config DEFAULT =
        ImmutableLogicalFilterReorderConditionRule.Config.of().withOperandFor(LogicalFilter.class);
