...
/**
 * NOTE: This is mostly copied from calcite but includes a bug fix that allows it to work in the
 * volcano planner.
 *
 ...
 *
 * <p>This rule never removes the last column, because {@code Aggregate([])} returns 1 row even if
 * its input is empty.
 *
...
@Value.Enclosing
public class VolcanoAcceptingAggregateProjectPullUpConstantsRule
    extends RelRule<VolcanoAcceptingAggregateProjectPullUpConstantsRule.Config>
    implements TransformationRule {

  /** Creates an AggregateProjectPullUpConstantsRule. */
  protected VolcanoAcceptingAggregateProjectPullUpConstantsRule(
      VolcanoAcceptingAggregateProjectPullUpConstantsRule.Config config) {
    super(config);
  }
  ...
  public void onMatch(RelOptRuleCall call) {
    ...
    // BODO CHANGE: replace aggregate.getInput() with input
  ...
  public interface Config extends RelRule.Config {
    VolcanoAcceptingAggregateProjectPullUpConstantsRule.Config DEFAULT =
        ImmutableVolcanoAcceptingAggregateProjectPullUpConstantsRule.Config.of();

    @Override
    default VolcanoAcceptingAggregateProjectPullUpConstantsRule toRule() {
      return new VolcanoAcceptingAggregateProjectPullUpConstantsRule(this);
    }
     ...
     */
    default VolcanoAcceptingAggregateProjectPullUpConstantsRule.Config withOperandFor(
        Class<? extends Aggregate> aggregateClass, Class<? extends RelNode> inputClass) {
      return withOperandSupplier(
              b0 ->
                  b0.operand(aggregateClass)
                      .predicate(Aggregate::isSimple)
                      .oneInput(b1 -> b1.operand(inputClass).anyInputs()))
          .as(VolcanoAcceptingAggregateProjectPullUpConstantsRule.Config.class);
    }
  }
}
