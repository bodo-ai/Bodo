...
class BodoLogicalAggregate (cluster: RelOptCluster,
    ...
    override fun copy(traitSet: RelTraitSet,
                      input: RelNode,
                      groupSet: ImmutableBitSet,
                      groupSets: List<ImmutableBitSet>?,
                      aggCalls: List<AggregateCall>): BodoLogicalAggregate {
    ...
    companion object {
        ...
        fun create(
            ...
            groupSets: ImmutableList<ImmutableBitSet>, aggCalls: List<AggregateCall>): BodoLogicalAggregate {
