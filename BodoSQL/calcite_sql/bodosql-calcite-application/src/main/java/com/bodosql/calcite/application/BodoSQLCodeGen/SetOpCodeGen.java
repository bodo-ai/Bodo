...
public class SetOpCodeGen {
  ...
  public static List<Op> generateIntersectCode(
    ...
    if (isAll) {
      ...
      // Generate temp vars
      final Variable lhsDfCnt = pdVisitorClass.genDfVar();
      final Variable rhsDfCnt = pdVisitorClass.genDfVar();
  ...
  public static List<Op> generateExceptCode(
    ...
    if (isAll) {
      ...
      final Variable lhsDfCnt = pdVisitorClass.genDfVar();
      final Variable rhsDfCnt = pdVisitorClass.genDfVar();
      final Variable rhsDfTmp = pdVisitorClass.genDfVar();
  ...
  private static Op generateCumcountDf(
    ...
    // Generate temp vars
    final Variable colOnes = pdVisitorClass.genSeriesVar();
    final Variable tableOnes = pdVisitorClass.genTableVar();
    final Variable dfOnes = pdVisitorClass.genDfVar();
    final Variable colCnt = pdVisitorClass.genSeriesVar();
    final Variable tableCnt = pdVisitorClass.genTableVar();
