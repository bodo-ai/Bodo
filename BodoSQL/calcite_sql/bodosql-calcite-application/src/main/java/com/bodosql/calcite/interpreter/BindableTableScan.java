 ...
 */
package com.bodosql.calcite.interpreter;
...
/**
 * Scan of a table that implements {@link ScannableTable} and therefore can be converted into an
 * {@link Enumerable}.
 */
public class BindableTableScan extends TableScan implements BindableRel {
  ...
  /** Creates a BindableTableScan. */
  public static BindableTableScan create(
      RelOptCluster cluster,
    ...
    final RelTraitSet traitSet =
        cluster
            .traitSetOf(BindableConvention.INSTANCE)
            .replaceIfs(
  ...
  public Enumerable<Object[]> bind(DataContext dataContext) {
    if (table.unwrap(ProjectableFilterableTable.class) != null) {
      return table
          .unwrap(ProjectableFilterableTable.class)
          .scan(dataContext, filters, projects.toIntArray());
