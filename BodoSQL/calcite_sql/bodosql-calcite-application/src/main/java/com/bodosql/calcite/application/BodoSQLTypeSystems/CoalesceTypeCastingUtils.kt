...
//        GEOMETRY,
    ...
    companion object {
        ...
        private val pairTypeMap: Map<Pair<SF_TYPE, SF_TYPE>, Pair<SF_TYPE, SqlOperator>?> = mapOf(
            ...
            Pair(SF_TYPE.VARCHAR, SF_TYPE.TIME) to Pair(SF_TYPE.TIME, DatetimeOperatorTable.TO_TIME),
            ...
            Pair(SF_TYPE.TIME, SF_TYPE.VARCHAR) to Pair(SF_TYPE.TIME, DatetimeOperatorTable.TO_TIME),
            ...
            Pair(SF_TYPE.TIMESTAMP_TZ, SF_TYPE.TIME) to Pair(SF_TYPE.TIME, DatetimeOperatorTable.TO_TIME),
            ...
            Pair(SF_TYPE.TIME, SF_TYPE.VARIANT) to Pair(SF_TYPE.TIME, DatetimeOperatorTable.TO_TIME),
            ...
            Pair(SF_TYPE.VARIANT, SF_TYPE.TIME) to Pair(SF_TYPE.TIME, DatetimeOperatorTable.TO_TIME),
