...
public class RexWindow {
    ...
    RexWindow(
        ...
        // BODO CHANGE: allow ROWS BETWEEN UNBOUNDED PRECEDING AND UNBOUNDED FOLLOWING
        // checkArgument(
    ...
    private StringBuilder appendDigest_(StringBuilder sb, boolean allowFraming) {
        ...
        // BODO CHANGE: always display the frame, for clarity, and skip
        // the special MySQL syntax
