 ...
 *
 * <p>Bodo change: this fork intentionally keeps the Calcite 1.41 unparse
 * behavior (no wrapping parentheses, e.g. {@code x :: TYPE} rather than
 * {@code (x :: TYPE)}) so that generated BodoSQL output remains Snowflake
 * compatible. The {@code unparse} override added in Calcite 1.42 is omitted.
 */
