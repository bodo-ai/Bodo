...
class AggChecker extends SqlBasicVisitor<Void> {
    ...
    @Override public Void visit(SqlIdentifier id) {
        ...
        // Bodo Change: Any parameter is just a "scalar", so it doesn't
        // need to be in the group by condition.
        if (scopes.getFirst().fullyQualifyIdentifierIfParameter(id) != null) {
            return null;
        }
