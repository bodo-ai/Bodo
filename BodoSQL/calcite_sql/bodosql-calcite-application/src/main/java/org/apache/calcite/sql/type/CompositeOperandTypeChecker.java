...
/**
 * This class is a copy paste of org.apache.calcite.sql.type.CompositeOperandTypeChecker,
 * with some changes necessary to properly handle POSITIVE_INTEGER_LITERAL inside a
 * SEQUENCE operand type checker. Changes are marked with "BODO CHANGE:"
 */
    ...
    case SEQUENCE:
      ...
      for (Ord<SqlOperandTypeChecker> ord
        ...
        if (!((SqlSingleOperandTypeChecker) rule).checkSingleOperandType(
            ...
            // BODO CHANGE
            // replaced rule.getClass() == FamilyOperandTypeChecker.class
            // This was causing issues with POSITIVE_INTEGER_LITERAL,
            // which is a child class of FamilyOperandTypeChecker,
            // but the above checker didn't return true
            rule instanceof FamilyOperandTypeChecker ? 0 : ord.i,
            throwOnFailure)) {
          if (callBinding.isTypeCoercionEnabled()) {
