...
def test_in_columns(basic_df, memory_leak_check):
...
@pytest.mark.slow
def test_in_scalars(basic_df, memory_leak_check):
...
def test_not_in_columns(basic_df, memory_leak_check):
...
@pytest.mark.slow
def test_not_in_scalars(basic_df, memory_leak_check):
...
def test_in_scalar_literals(basic_df, memory_leak_check):
...
@pytest.mark.slow
def test_not_in_scalar_literals(basic_df, memory_leak_check):
...
@pytest.mark.slow
def test_in_list_one_literal(basic_df, memory_leak_check):
...
@pytest.mark.slow
def test_in_scalar_with_scalar_literals(basic_df, memory_leak_check):
...
@pytest.mark.slow
def test_not_in_scalar_with_scalar_literals(basic_df, memory_leak_check):
