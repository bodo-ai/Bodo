...
def test_dict_other_string_kernels(args):
    def impl1(arg0, arg1, arg2):
        return pd.Series(bodosql.kernels.lpad(arg0, arg1, arg2)).str.capitalize()

    def impl2(arg0, arg1, arg2):
        return pd.Series(bodosql.kernels.rpad(arg0, arg1, arg2)).str.capitalize()

    def impl3(arg0, arg1):
        return pd.Series(bodosql.kernels.left(arg0, arg1)).str.capitalize()

    def impl4(arg0, arg1):
        return pd.Series(bodosql.kernels.right(arg0, arg1)).str.capitalize()

    def impl5(arg0, arg1):
        return pd.Series(bodosql.kernels.repeat(arg0, arg1)).str.capitalize()

    def impl6(arg0):
        return pd.Series(bodosql.kernels.reverse(arg0)).str.capitalize()

    def impl7(arg0, arg1, arg2):
        return pd.Series(bodosql.kernels.substring(arg0, arg1, arg2)).str.capitalize()

    def impl8(arg0, arg1, arg2):
        return pd.Series(
            bodosql.kernels.substring_index(arg0, arg1, arg2)
        ).str.capitalize()
...
def test_dict_str2int(args):
    def impl0(s):
        return bodosql.kernels.rtrimmed_length(s)

    def impl1(s, t):
        return bodosql.kernels.editdistance_no_max(s, t)

    def impl2(s, t, n):
        return bodosql.kernels.editdistance_with_max(s, t, n)

    def impl3(s, t):
        return bodosql.kernels.instr(s, t)

    def impl4(s, t):
        return bodosql.kernels.strcmp(s, t)

    def impl5(s):
        return bodosql.kernels.ord_ascii(s)

    def impl6(s, t, n):
        return bodosql.kernels.position(s, t, n)

    def impl7(s):
        return bodosql.kernels.to_double(s, None)
...
def test_dict_replace(args):
    ...
    def impl(arr, to_replace, replace_with):
        return pd.Series(
            bodosql.kernels.replace(arr, to_replace, replace_with)
        ).str.capitalize()
...
def test_dict_split_part(args):
    def impl(source, delim, part):
        return pd.Series(
            bodosql.kernels.split_part(source, delim, part)
        ).str.capitalize()
...
def test_dict_strtok(args):
    def impl(source, delim, part):
        return pd.Series(bodosql.kernels.strtok(source, delim, part)).str.capitalize()
...
def test_dict_coalesce(args):
    def impl(x, y):
        return pd.Series(bodosql.kernels.coalesce((x, y))).str.capitalize()
...
def test_dict_regexp(args, test):
    def impl1(source, pattern, flags):
        return pd.Series(bodosql.kernels.regexp_like(source, pattern, flags))

    def impl2(source, pattern, position, flags):
        return pd.Series(bodosql.kernels.regexp_count(source, pattern, position, flags))
...
def test_dict_nullif(args):
    def impl(x, y):
        return pd.Series(bodosql.kernels.nullif(x, y)).str.capitalize()
...
def test_dict_decode(args):
    def impl5(A, B, C, D, E):
        return pd.Series(bodosql.kernels.decode((A, B, C, D, E))).str.capitalize()

    def impl6(A, B, C, D, E, F):
        return pd.Series(bodosql.kernels.decode((A, B, C, D, E, F))).str.capitalize()
...
def test_dict_translate(args):
    def impl(arr, source, target):
        return pd.Series(
            bodosql.kernels.translate(arr, source, target)
        ).str.capitalize()
...
def test_dict_initcap(args):
    def impl(arr, delim):
        return pd.Series(bodosql.kernels.initcap(arr, delim)).str.strip()
...
def test_dict_str2bool(args, is_scalar_a, is_scalar_b, answers, func):
    def impl1(s, t):
        return bodosql.kernels.equal_null(s, t, is_scalar_a, is_scalar_b)

    def impl2(s, t):
        return bodosql.kernels.not_equal_null(s, t, is_scalar_a, is_scalar_b)

    def impl3(s, t):
        return pd.Series(bodosql.kernels.startswith(s, t))

    def impl4(s, t):
        return pd.Series(bodosql.kernels.endswith(s, t))
...
def test_dict_insert(args):
    def impl(source, pos, len, inject):
        return pd.Series(
            bodosql.kernels.insert(source, pos, len, inject)
        ).str.capitalize()
...
def test_dict_dayname(memory_leak_check):
    def impl(
        ...
        return pd.Series(bodosql.kernels.dayname(arr)).str.upper()
...
def test_dict_monthname(memory_leak_check):
    def impl(
        ...
        return pd.Series(bodosql.kernels.monthname(arr)).str.upper()
...
def test_dict_json_extract_path_text(data, path, answer, output_encoded):
    ...
    def impl(data, path):
        return pd.Series(bodosql.kernels.json_extract_path_text(data, path)).str.upper()
