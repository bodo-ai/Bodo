...
def test_convert_sql_pattern_to_python_compile_time(memory_leak_check):
    ...
    """
    func = bodo.ir.filter.convert_sql_pattern_to_python_compile_time
...
def test_like_constant_pattern_escape(is_case_insensitive, like_arr, memory_leak_check):
    ...
    def test_impl1(arr):
        ...
        return bodosql.kernels.like_kernel(arr, "helLo", "", is_case_insensitive)

    def test_impl2(arr):
        # Test ends with
        return bodosql.kernels.like_kernel(arr, "%Lo", "", is_case_insensitive)

    def test_impl3(arr):
        # Test starts with
        return bodosql.kernels.like_kernel(arr, "H%", "", is_case_insensitive)

    def test_impl4(arr):
        # Test contains
        return bodosql.kernels.like_kernel(arr, "%elL%", "", is_case_insensitive)

    def test_impl5(arr):
        # Test a regex
        return bodosql.kernels.like_kernel(arr, "he_Lo", "", is_case_insensitive)

    # Same tests but with escape
    def test_impl6(arr):
        # Test directly equality
        return bodosql.kernels.like_kernel(arr, "he^%Lo", "^", is_case_insensitive)
    ...
    def test_impl8(arr):
        # Test starts with
        return bodosql.kernels.like_kernel(arr, "He<%%", "<", is_case_insensitive)

    def test_impl9(arr):
        # Test contains
        return bodosql.kernels.like_kernel(arr, "%E&%l%", "&", is_case_insensitive)

    def test_impl10(arr):
        # Test a regex
        return bodosql.kernels.like_kernel(arr, "he^__Lo", "^", is_case_insensitive)
...
def test_like_scalar_pattern_escape(is_case_insensitive, like_arr, memory_leak_check):
    ...
    def test_impl1(arr, pattern):
        ...
        return bodosql.kernels.like_kernel(arr, pattern, "", is_case_insensitive)

    def test_impl2(arr, escape):
        # Test with only an escape
        return bodosql.kernels.like_kernel(arr, "he^%Lo", escape, is_case_insensitive)

    def test_impl3(arr, pattern, escape):
        # Test with a pattern and escape
        return bodosql.kernels.like_kernel(arr, pattern, escape, is_case_insensitive)
...
def test_like_kernel_optional(memory_leak_check):
    def impl(A, B, C, flag0, flag1, flag2):
        ...
        return bodosql.kernels.like_kernel(
            arg0, arg1, arg2, False
        ), bodosql.kernels.like_kernel(arg0, arg1, arg2, True)
