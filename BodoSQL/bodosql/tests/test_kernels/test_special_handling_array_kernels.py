...
def verify_dict_encoded_in_impl(impl, args):
    ...
    dispatcher, used_sig = find_nested_dispatcher_and_args(
        bodo_func, arg_typs, ("is_in", "bodosql.kernels")
    )
    ...
    dispatcher, used_sig = find_nested_dispatcher_and_args(
        dispatcher,
        used_sig,
        ("is_in_util", "bodosql.kernels.special_handling_array_kernels"),
    )
...
def test_is_in_option(memory_leak_check):
    ...
    def impl(A, flag0):
        ...
        return bodosql.kernels.is_in(arg0, search_vals)
...
def test_is_in_distribution_handling(memory_leak_check):
    ...
    def case_1(vals_to_search, vals_to_search_for):
        ...
        retval = bodosql.kernels.is_in(vals_to_search, vals_to_search_for)
        return retval
