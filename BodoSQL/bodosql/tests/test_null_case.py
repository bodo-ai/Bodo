...
def test_null_then_handled(bodosql_nullable_numeric_types, memory_leak_check):
...
@pytest.mark.slow
def test_null_then_multicolumn(bodosql_nullable_numeric_types, memory_leak_check):
    """tests a case statement that always evaluates to true propagates
...
def test_null_else(bodosql_nullable_numeric_types, memory_leak_check):
...
@pytest.mark.slow
def test_null_else_handled(bodosql_nullable_numeric_types, memory_leak_check):
...
@pytest.mark.slow
def test_null_else_multicolumn(bodosql_nullable_numeric_types, memory_leak_check):
    """tests a case statement that always evaluates to false propagates
    null values correctly using multiple columns."""
    query = (
...
@pytest.mark.slow
def test_null_when(bodosql_nullable_numeric_types, memory_leak_check):
...
@pytest.mark.slow
def test_null_when_multicolumn(bodosql_nullable_numeric_types, memory_leak_check):
...
def test_null_when_or(bodosql_nullable_numeric_types, memory_leak_check):
...
@pytest.mark.slow
def test_null_when_and(bodosql_nullable_numeric_types, memory_leak_check):
    """tests a case statement where when may have null values using or is handled properly."""
...
@pytest.mark.slow
def test_null_when_and_shortcircuit(bodosql_nullable_numeric_types, memory_leak_check):
    """tests a case statement where when may have null values using or is handled properly."""
...
def test_null_scalars_cast(basic_df, scalar_values, memory_leak_check):
