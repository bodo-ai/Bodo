            ...
            pd.DataFrame(
                {
                    ...
                    "RES": [
                        ...
                        "108.51053228",
                        "-645.12000000",
                        "0E-8" if bodosql.use_cpp_backend else "0.00000000",
                    ],
                }
            ),
            id="avg",
            ...
            pd.DataFrame(
                {
                    ...
                    if not bodosql.use_cpp_backend
                        ...
                        "0E-12",
                        "15432098765431790123456.790125000000",
                        None,
                        "0E-12",
                        "24999999999950000000.000025000000",
                        "10502331961653243347050.846288888900",
                        "20157638888914043055555.633718750000",
                        "48214.502663703092",
                        "0E-12",
                        "320.406250000000",
                    ],
            ...
            pd.DataFrame(
                {
                    ...
                    if not bodosql.use_cpp_backend
                        ...
                        "0E-1",
                        "20576131687242386831275.72016666666",
                        None,
                        None,
                        "49999999999900000000.00005000000",
                        "15753497942479865020576.26943333335",
                        "26876851851885390740740.84495833333",
                        "48225.42574994317",
                        None,
                        "427.20833333333",
                    ],
