...
def test_case_agg(bodosql_string_types, memory_leak_check):
    """
...
@pytest.mark.slow
@pytest.mark.bodosql_cpp
def test_boolean_literal_case(basic_df, memory_leak_check):
    """
...
def test_case_literals(basic_df, case_literals, memory_leak_check):
    """
...
@pytest.mark.slow
def test_case_literals_multiple_when(basic_df, case_literals, memory_leak_check):
    """
...
@pytest.mark.slow
def test_case_literals_groupby(basic_df, case_literals, memory_leak_check):
    """
...
def test_case_literals_multiple_when_groupby(
    basic_df, case_literals, memory_leak_check
):
    """
    Test a case statement with each possible literal return type in a groupby.
    """
...
@pytest.mark.bodosql_cpp
def test_case_literals_nonascii(basic_df, memory_leak_check):
    """
...
@pytest.mark.slow
@pytest.mark.bodosql_cpp
def test_case_agg_groupby(basic_df, memory_leak_check):
    """
...
@pytest.mark.slow
def test_case_no_else_clause_literals(basic_df, case_literals, memory_leak_check):
    """
...
@pytest.mark.bodosql_cpp
def test_case_no_else_clause_columns(basic_df, memory_leak_check):
    """
...
@pytest.mark.skipif(bodosql.use_cpp_backend, reason="JIT specific")
def test_case_no_inlining(basic_df, memory_leak_check):
    """
