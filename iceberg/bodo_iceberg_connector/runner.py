...
import bodo_iceberg_connector.bodo_apis.parquet_info
import bodo_iceberg_connector.bodo_apis.schema
...
bodo_typing_schema_info = (
    bodo_iceberg_connector.bodo_apis.schema.get_bodo_connector_typing_schema(
...
bodo_runtime_schema_info = (
    bodo_iceberg_connector.bodo_apis.schema.get_bodo_connector_runtime_schema(
        WAREHOUSE_LOC, DB_NAME, TABLE_NAME
    )
)
...
if TABLE_NAME == "partitions_dt_table":
    ...
    bodo_parquet_infos = (
        bodo_iceberg_connector.bodo_apis.parquet_info.bodo_connector_get_parquet_info(
