...
version = ".".join(bodo.__version__.split(".")[:2])
# The full version, including alpha/beta/rc tags.
release = bodo.__version__
...
latex_documents = [(master_doc, "Bodo.tex", "Bodo Documentation", "Bodo", "manual")]
...
man_pages = [(master_doc, "bodo", "Bodo Documentation", [author], 1)]
