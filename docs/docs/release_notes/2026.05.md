...
- Added support for specifying lists of functions in SeriesGroupby & DataFrameGroupby aggregate() function dicts (i.e. `df.groupby(...).agg({“col1”: [“mean”, “count”], “col2”: [“sum”, “count”]})`).
